...
export function CommunityModal({ visible, onClose }: Props) {
  ...
  const renderItem = ({ item }: { item: FeedItem }) => {
    ...
    const avatarColor = isFake ? (item as FakeMessage).avatarColor : hashColor(name);
            ...
            ListHeaderComponent={
              <View style={[styles.disclaimer, { backgroundColor: colors.card, borderColor: colors.border }]}>
                ...
                <Text style={[styles.disclaimerText, { color: colors.mutedForeground }]}>
                  {"Users with loose talk, vulgarity or offensive words will be banned immediately.\nHere we only talk about markets. — TEAM ALLADIN"}
                </Text>
              </View>
            }
          />
...
const styles = StyleSheet.create({
  ...
  communityIcon: { width: 38, height: 38, borderRadius: 19, alignItems: "center", justifyContent: "center" },
  headerInfo: { flex: 1 },
  ...
  disclaimerText: { fontSize: 11, fontFamily: "Inter_400Regular", lineHeight: 17, flex: 1 },
  ...
  bubbleOther: {
    maxWidth: "75%", paddingHorizontal: 12, paddingVertical: 9,
    borderRadius: 16, borderTopLeftRadius: 4, borderWidth: 1, gap: 2,
  },
  ...
  bubbleMe: {
    maxWidth: "75%", backgroundColor: "#10B981",
    paddingHorizontal: 13, paddingVertical: 9,
    borderRadius: 16, borderTopRightRadius: 4, gap: 2,
  },
  ...
  input: {
    ...
    fontSize: 14, maxHeight: 100, fontFamily: "Inter_400Regular",
  },
